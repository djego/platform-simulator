...
<head>
  ...
  <title>Lecsim Simulator Admin | @yield('title')</title>
      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          ...
          <div class="navbar nav_title" style="border: 0;">
            <a href="index.html" class="site_title"><i class="fa fa-gamepad"></i> <span>Lecsim</span></a>
          </div>
          ...
          <div class="profile">
            <div class="profile_pic">
              ...
              <img src="images/teacher.png" alt="..." class="img-circle profile_img">
              @else
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="">
                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                  @if(Auth::user()->is_teacher)
                  <img src="images/teacher.png" alt="">{{ Auth::user()->name }}
                  @else
